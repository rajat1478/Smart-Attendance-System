...
def function5():    
   os.system(os.getcwd()+"/developers/diet1frame1first.html");
...
def attend():
#	with open('firebase/attendance_files/attendance2018-04-24.xls','rt')as f:
#		data=csv.reader(f)
#		for row in data:
#			print(row)
	os.system(os.getcwd()+"/firebase/attendance_files/attendance"+str(datetime.now().date())+'.xls')
    #os.system(os.getcwd()+"/firebase/attendance_files/attendance2018-04-24.xls")
